...
<html>
    <head>
        ...
        <title><g:message code="exchangeRate.show" default="Show Exchange Rate" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="exchangeRate.show" default="Show Exchange Rate" /></h1>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="exchangeRate.currency" default="Currency"/>:</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="exchangeRate.version" default="Version" />:</td>
